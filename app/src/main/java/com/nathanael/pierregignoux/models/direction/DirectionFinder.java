...
public class DirectionFinder {
    ...
    public DirectionFinder(DirectionFinderListener listener, String origin, String destination, String methode) {
    ...
    private class DownloadRawData extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String res) {
            try {
                Log.d("JSON","dans le try du parse JSSON");
                parseJSon(res);
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        Log.d("JSON","pas comme toi");
        List<Route> routes = new ArrayList<Route>();
        JSONObject jsonData = new JSONObject(data);
        JSONArray jsonRoutes = jsonData.getJSONArray("routes");
        Log.d("JSON", String.valueOf(jsonRoutes));
        for (int i = 0; i < jsonRoutes.length(); i++) {
            JSONObject jsonRoute = jsonRoutes.getJSONObject(i);
            Route route = new Route();

            Log.d("JSON","comprend pas");
